...
public class Article implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -121531231888328771L;
	...
	public Article(Integer id, String title, String content, String picture, Integer channelId, Channel channel,
			String categoryId, Category category, Integer userId, User user, int hits, int hot, int status, int deleted,
			Date created, Date updated, int commentCnt, int articleType) {
		super();
		this.id = id;
		this.title = title;
